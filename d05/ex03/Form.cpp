...
/*   Updated: 2019/04/01 15:48:01 by abassibe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::NotSignedException::NotSignedException(NotSignedException const& copy) throw()
{
	(void)copy;
}
...
Form::NotSignedException	&Form::NotSignedException::operator=(NotSignedException const& copy) throw()
{
	(void)copy;
	return (*this);
}
